                ...
                )  
{
    ...
    // Note : 0,1,2 are Reserved just like the actual linux/unix
...
int UnlinkFile
            (
                char *name      // name of searching file
            )
{
    int i = 0;
...
//  Description     :   It is use to Read the Data from the file
//  Input           :   File Descriptor
